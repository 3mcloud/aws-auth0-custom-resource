...
def get(ids = False):
    ...
    cases = [{
        ...
        "StackEvents": [
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/fe7f9cb0-1474-11eb-aa91-12cf4a8c2bc2",
                "EventId": "1ca95280-1475-11eb-b0ad-0a374cd00e27",
                "StackName": "qa-cr-authn-failures",
                "LogicalResourceId": "qa-cr-authn-failures",
                "PhysicalResourceId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/fe7f9cb0-1474-11eb-aa91-12cf4a8c2bc2",
            ...
            },
            {
                ...
                "PhysicalResourceId": "/qa/auth0/authncrregression184518171237",
                "ResourceType": "Custom::Authn_Application",
                "Timestamp": "2020-10-22T14:44:38.097Z",
                "ResourceStatus": "DELETE_COMPLETE",
                "ResourceProperties": "{\"ServiceToken\":\"arn:aws:lambda:us-east-1:184518171237:function:qa-auth-custom-resource\",\"Connections\":[\"con_k4Jtslc6jOQq1rYy\"],\"Type\":\"m2m\",\"Tenant\":\"mmm-qa.auth0.com\",\"Description\":\"A failure to ensure resources aren't orphaned\",\"Name\":\"authn-cr-regression-184518171237\"}"
            },
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/fe7f9cb0-1474-11eb-aa91-12cf4a8c2bc2",
            ...
            },
            {
                ...
                "ResourceStatus": "DELETE_COMPLETE",
                "ResourceProperties": "{\"ServiceToken\":\"arn:aws:lambda:us-east-1:184518171237:function:qa-auth-custom-resource\",\"Tenant\":\"mmm-qa.auth0.com\",\"Audience\":\"https://authn-cr-failure.com\",\"ApplicationId\":\"hmODjO7fRD1rguDAdjcyf67bRZqDu0jF\"}"
            },
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/fe7f9cb0-1474-11eb-aa91-12cf4a8c2bc2",
        ...
        "StackEvents": [
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/e289fa60-1473-11eb-80df-0e765a9edd1f",
                "EventId": "ed70f690-1473-11eb-97a1-0a0faac5843d",
                "StackName": "qa-cr-authn-failures",
                "LogicalResourceId": "qa-cr-authn-failures",
                "PhysicalResourceId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/e289fa60-1473-11eb-80df-0e765a9edd1f",
                "ResourceType": "AWS::CloudFormation::Stack",
            ...
            },
            {
                ...
                "ResourceStatus": "CREATE_COMPLETE",
                "ResourceProperties": "{\"ServiceToken\":\"arn:aws:lambda:us-east-1:184518171237:function:qa-auth-custom-resource\",\"Tenant\":\"mmm-qa.auth0.com\",\"Audience\":\"https://authn-cr-failure.com\",\"ApplicationId\":\"QNFneHk2WMyjYuWtUvl21xspV0ZxM9Ba\"}"
            },
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/e289fa60-1473-11eb-80df-0e765a9edd1f",
            ...
            },
            {
                ...
                "ResourceStatus": "CREATE_COMPLETE",
                "ResourceProperties": "{\"ServiceToken\":\"arn:aws:lambda:us-east-1:184518171237:function:qa-auth-custom-resource\",\"Tenant\":\"mmm-qa.auth0.com\",\"Audience\":\"https://authn-cr-failure.com\",\"Name\":\"authn-cr-regression-api-184518171237\"}"
            },
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/e289fa60-1473-11eb-80df-0e765a9edd1f",
        ...
        "StackEvents": [
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/82f87f80-148d-11eb-a522-0ea47a628cf7",
                "EventId": "d41285a0-148d-11eb-8203-0a4db9a5d67f",
                "StackName": "qa-cr-authn-failures",
                "LogicalResourceId": "qa-cr-authn-failures",
                "PhysicalResourceId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/82f87f80-148d-11eb-a522-0ea47a628cf7",
                "ResourceType": "AWS::CloudFormation::Stack",
            ...
            },
            {
                ...
                "ResourceStatus": "CREATE_FAILED",
                "ResourceStatusReason": "Failed to create resource. 404: No resource with identifier https://authn-cr-failure.com",
                "ResourceProperties": "{\"ServiceToken\":\"arn:aws:lambda:us-east-1:184518171237:function:qa-auth-custom-resource\",\"Tenant\":\"mmm-qa.auth0.com\",\"Audience\":\"https://authn-cr-failure.com\",\"ApplicationId\":\"bD802jihR56shFVTpgA8uznIu8s5fKaI\"}"
            },
            {
                "StackId": "arn:aws:cloudformation:us-east-1:184518171237:stack/qa-cr-authn-failures/82f87f80-148d-11eb-a522-0ea47a628cf7",
